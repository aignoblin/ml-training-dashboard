...
const assetsURL = function(dep) {
  return "/ml-training-dashboard/" + dep;
};
const seen = {};
...
function ThemeProvider({ children }) {
  const [theme, setTheme] = reactExports.useState("minimal");
  return /* @__PURE__ */ jsxRuntimeExports.jsx(ThemeContext.Provider, { value: { theme, setTheme, themeConfig: themes[theme] }, children });
}
function useTheme() {
...
const FileUp = createLucideIcon("file-up", __iconNode$9);
/**
 * @license lucide-react v0.563.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
function ThemeSwitcher() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `flex items-center gap-3 ${themeConfig.text}`, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "select",
      {
        ...
        children: themeList.map((t) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: t.id, className: "bg-gray-900 text-white", children: t.name }, t.id))
      }
    )
  ] });
}
function Layout({ children }) {
  ...
  const navItems = [
    ...
    { path: "/metrics", icon: ChartColumn, label: "Metrics" }
  ];
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `min-h-screen ${themeConfig.bg} ${theme === "terminal" ? "terminal-text" : ""}`, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: `${themeConfig.card} ${themeConfig.cardBorder} border-b px-6 py-4`, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Activity, { className: `w-8 h-8 ${themeConfig.accent}` }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: `text-xl font-bold ${themeConfig.text}`, children: theme === "terminal" ? "> ML_TRAINING_SYS" : "ML Training Dashboard" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(ThemeSwitcher, {})
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: `${themeConfig.card} border-b ${themeConfig.cardBorder} px-6 py-2`, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto flex gap-4", children: navItems.map((item) => {
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsxs(
        ...
        {
          to: item.path,
          className: `flex items-center gap-2 px-4 py-2 rounded-lg transition-colors ${isActive ? `${themeConfig.primary}` : `${themeConfig.textMuted} hover:${themeConfig.text}`}`,
          children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "max-w-7xl mx-auto px-6 py-8", children }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: `${themeConfig.textMuted} text-center py-4 text-sm`, children: theme === "terminal" ? "// ML Training Dashboard v1.0 | STATUS: OPERATIONAL" : "ML Training Dashboard • Built for Petr" })
  ] });
}
function ProgressBar({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `${height} ${themeConfig.progressBg} rounded-full overflow-hidden ${theme === "terminal" ? "border border-green-500/30" : ""}`, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        className: `h-full ${themeConfig.progressFill} rounded-full transition-all duration-500 ease-out ${animated && progress > 0 && progress < 100 ? "animate-progress-stripe" : ""}`,
        style: { width: `${Math.min(100, Math.max(0, progress))}%` }
      }
    ) }),
    showPercentage && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `mt-1 text-sm ${themeConfig.textMuted} text-right`, children: theme === "terminal" ? `[${progress.toFixed(1)}%]` : `${progress.toFixed(1)}%` })
  ] });
}
function StatCard({ title, value, subtitle, icon, trend, trendValue }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `${themeConfig.card} ${themeConfig.cardBorder} rounded-xl p-6`, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: `text-sm ${themeConfig.textMuted}`, children: theme === "terminal" ? `// ${title.toUpperCase()}` : title }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: `text-3xl font-bold mt-2 ${themeConfig.text}`, children: theme === "terminal" ? `> ${value}` : value }),
      subtitle && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: `text-sm mt-1 ${themeConfig.textMuted}`, children: subtitle }),
      trend && trendValue && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: `text-sm mt-2 flex items-center gap-1 ${trendColors[trend]}`, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: trendSymbols[trend] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: trendValue })
      ] })
    ] }),
    icon && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `p-3 rounded-lg ${themeConfig.progressBg}`, children: icon })
  ] }) });
}
function UploadPage() {
  const { themeConfig, theme } = useTheme();
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: `text-2xl font-bold ${themeConfig.text}`, children: theme === "terminal" ? "$ UPLOAD_AND_TRAIN" : "Upload & Train" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: themeConfig.textMuted, children: theme === "terminal" ? "// Configure training parameters and start model training" : "Configure your training parameters and start the model training process" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-3 gap-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-2 space-y-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `${themeConfig.card} ${themeConfig.cardBorder} rounded-xl p-6`, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h3", { className: `text-lg font-semibold mb-4 ${themeConfig.text} flex items-center gap-2`, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(FileUp, { className: "w-5 h-5" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              className: `border-2 border-dashed rounded-xl p-8 text-center transition-colors cursor-pointer
                ${dragActive ? `${themeConfig.accent} border-current` : `${themeConfig.inputBorder}`}
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(Upload, { className: `w-12 h-12 mx-auto mb-4 ${themeConfig.textMuted}` }),
                selectedFile ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: `font-medium ${themeConfig.text}`, children: theme === "terminal" ? `> FILE: ${selectedFile.name}` : selectedFile.name }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: `text-sm ${themeConfig.textMuted}`, children: [
                    (selectedFile.size / 1024 / 1024).toFixed(2),
                    " MB"
                  ] })
                ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: `font-medium ${themeConfig.text}`, children: theme === "terminal" ? "> DRAG_FILE_HERE" : "Drag and drop your dataset here" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: `text-sm ${themeConfig.textMuted}`, children: theme === "terminal" ? "// Supports: .csv, .json, .parquet, .zip" : "Supports CSV, JSON, Parquet, or ZIP files" })
                ] })
              ]
            }
          )
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `${themeConfig.card} ${themeConfig.cardBorder} rounded-xl p-6`, children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: labelClass, children: theme === "terminal" ? "// MODEL_TYPE" : "Model Type" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "select",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "transformer", children: "Transformer" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "cnn", children: "CNN" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "rnn", children: "RNN / LSTM" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "mlp", children: "MLP" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "resnet", children: "ResNet" })
                  ]
                }
              )
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: labelClass, children: theme === "terminal" ? "// OPTIMIZER" : "Optimizer" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "select",
                {
                  ...
                  className: inputClass,
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "adam", children: "Adam" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "sgd", children: "SGD" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "rmsprop", children: "RMSprop" }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: labelClass, children: theme === "terminal" ? "// EPOCHS" : "Number of Epochs" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "input",
                {
                  type: "number",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: labelClass, children: theme === "terminal" ? "// BATCH_SIZE" : "Batch Size" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "input",
                {
                  type: "number",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: labelClass, children: theme === "terminal" ? "// LEARNING_RATE" : "Learning Rate" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "input",
                {
                  type: "text",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: labelClass, children: theme === "terminal" ? "// TRAIN_SPLIT_%" : "Training Split (%)" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "input",
                {
                  type: "number",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            ...
            children: isRunning ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 border-4 border-current border-t-transparent rounded-full animate-spin" }),
        ...
        (isRunning || progress > 0) && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `${themeConfig.card} ${themeConfig.cardBorder} rounded-xl p-6`, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h3", { className: `text-lg font-semibold mb-4 ${themeConfig.text} flex items-center gap-2`, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Zap, { className: "w-5 h-5" }),
            theme === "terminal" ? "> TRAINING_PROGRESS" : "Training Progress"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(ProgressBar, { progress, animated: isRunning, height: "h-6" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `mt-4 flex justify-between ${themeConfig.textMuted}`, children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: theme === "terminal" ? `ETA: ${stats.eta}` : `Estimated time remaining: ${stats.eta}` })
          ] })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: `text-lg font-semibold ${themeConfig.text} flex items-center gap-2`, children: theme === "terminal" ? "> LIVE_STATS" : "Live Statistics" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          StatCard,
          {
            title: "Current Epoch",
            ...
            icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Cpu, { className: `w-5 h-5 ${themeConfig.accent}` })
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          StatCard,
          {
            ...
            icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Database, { className: `w-5 h-5 ${themeConfig.accent}` })
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          StatCard,
          {
            ...
            icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Zap, { className: `w-5 h-5 ${themeConfig.accent}` })
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          StatCard,
          {
            ...
            icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Clock, { className: `w-5 h-5 ${themeConfig.accent}` })
          }
        )
      ] })
    ] })
...
function MetricsPage() {
  ...
  const tabClass = (active) => `px-4 py-2 rounded-lg transition-colors ${active ? `${themeConfig.primary}` : `${themeConfig.textMuted} hover:${themeConfig.text}`}`;
  const renderTerminalChart = () => {
    const maxHeight = 10;
    const data = mockTrainingHistory.map((h) => h.trainAcc);
    const max = Math.max(...data);
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-mono text-xs", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col", children: [
      Array.from({ length: maxHeight }).map((_, row) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "w-8 text-right pr-2", children: [
          Math.round((maxHeight - row) * max / maxHeight),
          "%"
        ] }),
        ...
        data.map((val, col) => {
          ...
          return /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-6 text-center", children: shouldFill ? "█" : " " }, col);
        })
      ] }, row)),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-8" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "└" }),
        data.map((_, i) => /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-6 text-center", children: "─" }, i))
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-8" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: " " }),
        data.map((_, i) => /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-6 text-center", children: i + 1 }, i))
      ] })
    ] }) });
  };
  const renderVisualChart = () => {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: `text-sm font-medium mb-3 ${themeConfig.textMuted}`, children: "Training Loss Over Epochs" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-end h-40 gap-2", children: data.map((d, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 flex flex-col items-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full flex flex-col justify-end h-32", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `text-xs mt-1 ${themeConfig.textMuted}`, children: d.epoch })
        ] }, i)) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: `text-sm font-medium mb-3 ${themeConfig.textMuted}`, children: "Accuracy Over Epochs" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-end h-40 gap-2", children: data.map((d, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 flex flex-col items-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full flex flex-col justify-end h-32", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              className: `w-full rounded-t transition-all hover:opacity-80 ${theme === "gradient" ? "bg-gradient-to-t from-pink-500 to-violet-500" : themeConfig.progressFill}`,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: `text-2xl font-bold ${themeConfig.text}`, children: theme === "terminal" ? "$ METRICS_DASHBOARD" : "Metrics Dashboard" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: themeConfig.textMuted, children: theme === "terminal" ? "// Monitor training metrics and experiment results" : "Monitor your training metrics and experiment results" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          ...
          children: theme === "terminal" ? "[OVERVIEW]" : "Overview"
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          ...
          children: theme === "terminal" ? "[HISTORY]" : "Training History"
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          ...
          children: theme === "terminal" ? "[EXPERIMENTS]" : "Experiments"
        }
      )
    ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          StatCard,
          {
            ...
            icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Target, { className: `w-5 h-5 ${themeConfig.accent}` })
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          StatCard,
          {
            ...
            icon: /* @__PURE__ */ jsxRuntimeExports.jsx(TrendingUp, { className: `w-5 h-5 ${themeConfig.accent}` })
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          StatCard,
          {
            ...
            icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Layers, { className: `w-5 h-5 ${themeConfig.accent}` })
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          StatCard,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `${themeConfig.card} ${themeConfig.cardBorder} rounded-xl p-6`, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: themeConfig.textMuted, children: theme === "terminal" ? "// PRECISION" : "Precision" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Gauge, { className: `w-5 h-5 ${themeConfig.accent}` })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `text-4xl font-bold ${themeConfig.text}`, children: "93.2%" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `h-2 ${themeConfig.progressBg} rounded-full mt-3`, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `h-full ${themeConfig.progressFill} rounded-full`, style: { width: "93.2%" } }) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `${themeConfig.card} ${themeConfig.cardBorder} rounded-xl p-6`, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: themeConfig.textMuted, children: theme === "terminal" ? "// RECALL" : "Recall" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Activity, { className: `w-5 h-5 ${themeConfig.accent}` })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `text-4xl font-bold ${themeConfig.text}`, children: "91.7%" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `h-2 ${themeConfig.progressBg} rounded-full mt-3`, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `h-full ${themeConfig.progressFill} rounded-full`, style: { width: "91.7%" } }) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `${themeConfig.card} ${themeConfig.cardBorder} rounded-xl p-6`, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: themeConfig.textMuted, children: theme === "terminal" ? "// F1_SCORE" : "F1 Score" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(TrendingUp, { className: `w-5 h-5 ${themeConfig.accent}` })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `text-4xl font-bold ${themeConfig.text}`, children: "92.4%" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `h-2 ${themeConfig.progressBg} rounded-full mt-3`, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `h-full ${themeConfig.progressFill} rounded-full`, style: { width: "92.4%" } }) })
        ] })
      ] })
    ] }),
    selectedTab === "history" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `${themeConfig.card} ${themeConfig.cardBorder} rounded-xl overflow-hidden`, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { className: themeConfig.tableHeader, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: `px-6 py-4 text-left ${themeConfig.text}`, children: theme === "terminal" ? "EPOCH" : "Epoch" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: `px-6 py-4 text-left ${themeConfig.text}`, children: theme === "terminal" ? "TRAIN_LOSS" : "Train Loss" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: `px-6 py-4 text-left ${themeConfig.text}`, children: theme === "terminal" ? "VAL_LOSS" : "Val Loss" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: `px-6 py-4 text-left ${themeConfig.text}`, children: theme === "terminal" ? "TRAIN_ACC" : "Train Acc" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: `px-6 py-4 text-left ${themeConfig.text}`, children: theme === "terminal" ? "VAL_ACC" : "Val Acc" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: `px-6 py-4 text-left ${themeConfig.text}`, children: theme === "terminal" ? "TREND" : "Trend" })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: mockTrainingHistory.map((row, index2) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "tr",
        {
          className: index2 % 2 === 0 ? themeConfig.tableRow : themeConfig.tableRowAlt,
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: `px-6 py-4 ${themeConfig.text}`, children: theme === "terminal" ? `[${row.epoch}]` : row.epoch }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: `px-6 py-4 ${themeConfig.text}`, children: row.trainLoss.toFixed(3) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: `px-6 py-4 ${themeConfig.text}`, children: row.valLoss.toFixed(3) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { className: `px-6 py-4 ${themeConfig.text}`, children: [
              row.trainAcc.toFixed(1),
              "%"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { className: `px-6 py-4 ${themeConfig.text}`, children: [
              row.valAcc.toFixed(1),
              "%"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-6 py-4", children: index2 > 0 && mockTrainingHistory[index2 - 1].trainLoss > row.trainLoss ? /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: `flex items-center gap-1 ${themeConfig.success}`, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowDownRight, { className: "w-4 h-4" }),
              theme === "terminal" ? "IMPROVING" : "Improving"
            ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: `flex items-center gap-1 ${themeConfig.warning}`, children: [
    ...
    selectedTab === "experiments" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `${themeConfig.card} ${themeConfig.cardBorder} rounded-xl overflow-hidden`, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { className: themeConfig.tableHeader, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: `px-6 py-4 text-left ${themeConfig.text}`, children: theme === "terminal" ? "EXP_ID" : "Experiment ID" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: `px-6 py-4 text-left ${themeConfig.text}`, children: theme === "terminal" ? "MODEL" : "Model" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: `px-6 py-4 text-left ${themeConfig.text}`, children: theme === "terminal" ? "ACCURACY" : "Accuracy" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: `px-6 py-4 text-left ${themeConfig.text}`, children: theme === "terminal" ? "LOSS" : "Loss" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: `px-6 py-4 text-left ${themeConfig.text}`, children: theme === "terminal" ? "DURATION" : "Duration" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: `px-6 py-4 text-left ${themeConfig.text}`, children: theme === "terminal" ? "STATUS" : "Status" })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: mockExperiments.map((exp, index2) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "tr",
        {
          className: index2 % 2 === 0 ? themeConfig.tableRow : themeConfig.tableRowAlt,
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: `px-6 py-4 font-mono ${themeConfig.accent}`, children: exp.id }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: `px-6 py-4 ${themeConfig.text}`, children: exp.model }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { className: `px-6 py-4 ${themeConfig.text}`, children: [
              exp.accuracy,
              "%"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: `px-6 py-4 ${themeConfig.text}`, children: exp.loss.toFixed(3) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: `px-6 py-4 ${themeConfig.textMuted}`, children: exp.duration }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-6 py-4", children: exp.status === "completed" ? /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: `flex items-center gap-1 ${themeConfig.success}`, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheckBig, { className: "w-4 h-4" }),
              theme === "terminal" ? "OK" : "Completed"
            ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: `flex items-center gap-1 ${themeConfig.error}`, children: [
